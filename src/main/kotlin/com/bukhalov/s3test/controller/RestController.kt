...
class RestController(private val s3Service: S3Service) {
    ...
    fun doWorkUnderDB(): ResponseEntity<String> {
        ...
        return ResponseEntity("Return", OK)
    }
...
/**
    ...
    fun doWorkUnderFileSystem(@RequestParam(value = "path") path: String): ResponseEntity<String> {
        s3Service.putFileFromFileSystem(path)
        return ResponseEntity("Return", OK)
    }
}
